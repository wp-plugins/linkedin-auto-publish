<?php if(get_option('xyz_lnap_premium_version_ads')==1){?>
...
<td style="float:right;">
	<a class="xyz_lnap_link"  target="_blank" href="http://kb.xyzscripts.com/wordpress-plugins/linkedin-auto-publish/">FAQ</a> | 
</td>
<td style="float:right;">
	<a class="xyz_lnap_link"  target="_blank" href="http://docs.xyzscripts.com/wordpress-plugins/linkedin-auto-publish/">Readme</a> | 
</td>
<td style="float:right;">
