...
if(!function_exists('xyz_lnap_links')){
	function xyz_lnap_links($links, $file) {
		...
		if ($file == $base) {
			...
			$links[] = '<a href="http://kb.xyzscripts.com/wordpress-plugins/linkedin-auto-publish/"  title="FAQ">FAQ</a>';
			$links[] = '<a href="http://docs.xyzscripts.com/wordpress-plugins/linkedin-auto-publish/"  title="Read Me">README</a>';
